...
for label, source in [('phone','phone-1080p60-20260906_030954.mp4'),('macbook','macbook-720p30-20260905T175716Z.mp4')]:
    output=root/f'sessions/opt-20260908-full-ort129-{label}.json'
    argv=[sys.executable,'-m','motioncapture.wholebody_recorded_preview',str(root/'benchmarks/inputs'/source),'--provider','coreml-all','--allow-cpu-partitions','--research-only','--expected-ort-version','1.29.0','--opencv-threads','1','--display-backend','opencv','--output',str(output)]
